...
# Load RGB images, depth maps, poses and calibration
train_rgb, ood_rgb, \
...
plt.title('OOD Score Heatmap')
plt.axis('off')
plt.savefig(os.path.join(data_dir, 'score_map_heatmap.png'), bbox_inches='tight', dpi=300)
plt.close()
